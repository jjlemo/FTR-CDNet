...
def get_args():
    ...
    parser.add_argument('--project_name', default='FTRNet_V1', type=str)
    parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
    parser.add_argument('--checkpoint_root', default='checkpoints', type=str)
    parser.add_argument('--output_folder', default='predict/FTRNet_V1_S2Looking', type=str)

    # data
    parser.add_argument('--num_workers', default=0, type=int)
    parser.add_argument('--dataset', default='CDDataset', type=str)
    parser.add_argument('--data_name', default='S2Looking', type=str)
    ...
    parser.add_argument('--net_G', default='TIPCD_V5', type=str,
...
if __name__ == '__main__':
    ...
    data_loader = utils.get_loader(args.data_name, img_size=args.img_size,
                                   ...
                                   split=args.split, dataset=args.dataset, is_train=False)

    model = MITCDEvaluator(args)

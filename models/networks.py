...
import models
from models.FTRNet import FTRNet_V1,FTRNet_V2,FTRNet_V4
from models.FTR_Ablation import FSRNet, FTRNet_Ablation_V2, FTRNet_Ablation_V3, FTRNet_Ablation_V4,FTRNet_Ablation_V5
...
def define_G(args, init_type='normal', init_gain=0.02, gpu_ids=[]):
    ...
    #     net = MIT_CD_v3()
        ...
        net = FSRNet()
    elif args.net_G == 'FTRNet_Ablation_V4':
        net = FTRNet_Ablation_V4()
    elif args.net_G == 'FTRNet_Ablation_V3':
        net = FTRNet_Ablation_V3()
    elif args.net_G == 'FTRNet_Ablation_V5':
        net = FTRNet_Ablation_V5()
    else:

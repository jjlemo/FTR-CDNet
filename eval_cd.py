...
def main():
    ...
    parser.add_argument('--project_name', default='HRSCD_SECOND', type=str)
    parser.add_argument('--print_models', default=False, type=bool, help='print models')

    # data
    parser.add_argument('--num_workers', default=4, type=int)
    parser.add_argument('--dataset', default='CDDataset', type=str)
    parser.add_argument('--data_name', default='SECOND', type=str)
    ...
    parser.add_argument('--net_G', default='FTR_Net_V1', type=str,
